...
clear options.u0
clear sol
load parametersSampling_woB
clear parameters
clear optionsMultistarts
load resultsSampling_woB
...
save(['parametersProfileSampling_woB_' num2str(n)],'parameters')
end