...
if n==1
    save(['parametersSampling_wB_' num2str(n)],'parameters','options','optionsMultistart')
elseif n==81
    save(['parametersSampling_wB_' num2str(n)],'parameters','options','optionsMultistart')
elseif n==161
    save(['parametersSampling_wB_' num2str(n)],'parameters','options','optionsMultistart')
else
    save(['parametersSampling_wB_' num2str(n)],'parameters')
end
end
