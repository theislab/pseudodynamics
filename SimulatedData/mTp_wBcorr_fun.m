function [] = mTp_wBcorr_fun(n)
% compute the profile likelihood for the n-th parameter for the simulated 
% biased data set with bias correction in the likelihood using PESTO
n = str2num(n);
...
clear options.u0
clear sol
load parametersSampling_wBcorr
clear parameters
clear optionsMultistarts
load resultsSampling_wBcorr
...
save(['parametersProfileSampling_wBcorr_' num2str(n)],'parameters')
end