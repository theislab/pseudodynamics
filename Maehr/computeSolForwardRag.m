function [varargout] = computeSolForwardRag(parameters,D,options)
D1 = parameters(1:9);
D2 = parameters(10:12);
v1 = parameters(13:21);
v2 = parameters(22:24);
...
grid0 = options.grid0(3);
ab1 = simpleSplineSym((0:0.125:1)',a1(:),grid_x);
ab1(end-grid0:end) = -3*ones(1,grid0+1);
...
sol = simulate_pd_branching_Rag_forward(D.pop.t,theta,options.u0,[],[]);
