...
% for the compartment model with constant rates using PESTO
...
objectiveFunction = @(theta) llCompartmentQiu(theta,modelfun,D,options);
...
save('parametersCompQiu','parameters','options','optionsMultistart')
