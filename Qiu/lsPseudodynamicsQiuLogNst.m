function [lS,grad] = lsPseudodynamicsQiuLogNst(varargin)
% compute the log likelihood value for Qiu data using state- and
...
% evaluate likelihood for Least squares ansatz
