...
% for the simulated data set using PESTO
n = str2num(n);
...
if n==1
    save(['parametersExample_' num2str(n)],'parameters','options','optionsMultistart')
elseif n==81
    save(['parametersExample_' num2str(n)],'parameters','options','optionsMultistart')
elseif n==161
    save(['parametersExample_' num2str(n)],'parameters','options','optionsMultistart')
else
    save(['parametersExample_' num2str(n)],'parameters')
end
end