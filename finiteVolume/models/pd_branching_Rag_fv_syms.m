function [model] = pd_branching_Rag_fv_syms( )
% finite volume implementation for the pseudodynamics model with branching for Maehr data with WT and KO
...
% for length of grid interval, h, (1/h)^2
...
% splines on grid(20):grid(end) => Interval 0:278/299
